...
# date = 24th June 2020
# description = Management/contact matrices for model with shielding strategy- people in the green zone can visit with 2 family members per week
# Creates 3 matrices:  
...
# usage = script should be run within the folder "data/real_models/model_1_1". 
### Setup

library(tidyverse)
setwd("data/real_models/model_1_1")
