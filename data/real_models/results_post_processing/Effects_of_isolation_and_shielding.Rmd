...
Based on these findings, we recommend the following:  
  1. Preventing deaths by placing a significant focus on increasing isolation capacity as soon as possible, and promptly isolating any individuals with symptoms common to COVID-19 (fever, cough, loss of smell, etc) as soon as the capacity exists to do so.  
  2. Buying time to build up more capacity to manage an outbreak by shielding vulnerable people in "green zones", as well as isolating symptomatic cases. This additional time obtained should be used to further increase isolation capacity, and to improve screening for common COVID-19 symptoms.
