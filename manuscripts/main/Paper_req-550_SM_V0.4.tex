...
zone with 2 contacts per week (Safety zone).}
\end{figure}
\medskip{}
...
\begin{figure}[H]
\centering{}\includegraphics[width=1\textwidth]{figures/newFig/FigS4}\hspace{2mm}\caption{\label{fig:Suppl_combined} \textbf{Combined interventions.} CFR (left),
and fraction of the population that recovers (right) for different
