...
\usepackage{lipsum}
\usepackage{xr}
\externaldocument{Paper_req-550_SM_V0.5.2}
...
\title{Feasible strategies \\ to minimize the spread of COVID-19 \\ in high-density informal settlements}
...
\textbf{\normalsize{}Methods and Findings}{\normalsize\par}
...
20 cases. This leads to an anomalous increase in CFR in some of the
