...
\usepackage{xr}
\externaldocument{Paper_req-550_V0.5.2}
...
\title{Supplementary Methods and Results\\Feasible strategies \\ to minimize the spread of COVID-19 \\ in informal settlements}
...
\begin{figure}[H]
\centering{}\includegraphics[width=1\textwidth]{figures/FigS3}\hspace{2mm}\caption{\label{fig:Suppl_self} \textbf{Self-distancing.} CFR (left), and
...
\begin{figure}[H]
\centering{}\includegraphics[width=1\textwidth]{figures/FigS4}\hspace{2mm}\caption{\label{fig:Suppl_isolation} \textbf{Self-isolation.} CFR (left),
...
\begin{figure}[H]
\centering{}\includegraphics[width=1\textwidth]{figures/Fig_S13}\hspace{2mm}\caption{\label{fig:Suppl_combined} \textbf{Combined interventions.} CFR (top),
