...
younger adults in age group 2. In accordance with camp manager expectations
...
safety zone have in the buffer zone per week. All figures consider
...
\begin{table}
\includegraphics{figures/table_combined_low_total_S}

\caption{\label{tab:CFR_discrete} Effectiveness of the green zone. (\textless 20
cases) Number of simulations with less than 20 infectious cases recorded
in the green zone. (Total) Number of simulations with at least one
death. The total number of simulations is 500. For the most effective
interventions, most of the simulations recording at least one death
have less than 20 infectious cases. For them, the discretization of
the possible values that the CFR can take, explains its apparently
anomalous increase in Supplementary Fig. \ref{fig:Suppl_combined}.}
