...
\usepackage{lipsum}
\usepackage{xr}
\externaldocument{Paper_req-550_SM_V0.4}
\usepackage{lineno}
...
worldwide, where crowded living conditions pose additional challenges
...
to implement. In this study, we investigated the impact of a series
of non-pharmaceutical interventions adapted to informal settlements
located in Northwest Syria, a region immersed in protracted conflict.}{\normalsize\par}
...
scenario where there is no healthcare available. We evaluated interventions
adapted to the living conditions in the camps, including moderate
self-distancing, self-isolation of symptomatic individuals, and protection
of the most vulnerable in \textquotedblleft safety zones\textquotedblright . }{\normalsize\par}
...
reduces mortality and the probability of an outbreak. Our model predicts
that a combination of simulated interventions may reduce mortality
by as much as 80\%. The time until the number of symptomatic cases
peaks is delayed with most of the interventions, in some cases by
more than three months. The proportion of the population that recovers,
...
to mitigate the effects of the pandemic. They not only demonstrate
how interventions explored for other settings may be adapted to Syrian
Internally Displaced Persons camps, but that similar interventions
may be applicable to controlling COVID-19 in informal settlements
around the world.}{\normalsize\par}
...
distributed, with a mean of 940. We simulated camps with populations
...
age groups: children (age 1, 0-12 years old), working-age adults (age
...
by more than 50\%. For a working-age adult, this would mean 7.5 contacts
per day.
...
the mean of of an outcome for the whole population is not the weighted
...
However, further increasing the number of tents significantly augments
this reduction until there is 1 per every 10 people (Kruskal-Conover
post-hoc-test, p-val$<3\times10^{-5}$). However, mortality begins
to slightly increase again after this threshold. This effect is a
consequence of having one carer per individual isolated (see Supplementary
Material), so when the isolated (infected) population increases, the
number of healthy working-age adults in contact with them increases
in tandem. Nevertheless, we observe a continuous reduction in CFR,
albeit small, with an increasing number of tents (see Supplementary
...
(see Fig. \ref{fig:Panel2}I); this effect  is notobserved globally..
...
2 contacts per week in the buffer zone, health checks, a moderate
...
be circumvented through the creation of a more organized, specific
dedicated group of carers, thus reducing the number of healthy working-age
adults in contact with isolated (infectious) individuals.
...
These result respond to concerns raised around this type of intervention
based on previous experiences with large numbers of fatalities registered
...
the feasibility of our proposed interventions. But one example we
...
may take years to build the needed capacity for an effective response.
...
and Bryan Grenfell's groups for useful discussions. ECF's research
is supported by Wellcome Trust grant 204833/Z/16/Z.
