...
setwd(dirOut)
write_csv(camps_pop, "camp_level.csv")
write_csv(community_pop, "community_level.csv")
write_csv(cluster_pop, "cluster_level.csv")
write_csv(sub_district_pop, "district_level.csv")
write_csv(governorate_pop, "governorate_level.csv")
write_csv(all_pop, "entire_population.csv")
