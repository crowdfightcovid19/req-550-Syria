...
varY = "Ndeaths"
ylabel = "Samples w/ deaths"

gg.b <- do_line_plot(df.lock,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)

varY = "Nnodeaths"
ylabel = "Samples w/o deaths"

gg.c <- do_line_plot(df.lock,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)

pdf(file=paste(outFile,"_outbreak.pdf",sep=""),width=30,height = 8,title=outFile)
grid.arrange(gg.a,gg.b,gg.c,ncol=3,nrow=1)
dev.off( )
...
gg.b <- do_line_plot(df.tcheck,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)

varY = "Nnodeaths"
ylabel = "Samples w/o deaths"

gg.c <- do_line_plot(df.tcheck,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)

gg.a<-gg.a+theme(axis.text.x = element_text(size=axis.text.x.size,angle=45,hjust=1,vjust=1))
gg.b<-gg.c+theme(axis.text.x = element_text(size=axis.text.x.size,angle=45,hjust=1,vjust=1))
gg.b<-gg.c+theme(axis.text.x = element_text(size=axis.text.x.size,angle=45,hjust=1,vjust=1))

pdf(file=paste(outFile,"_outbreak.pdf",sep=""),width=30,height = 9,title=outFile)
grid.arrange(gg.a,gg.b,gg.c,ncol=3,nrow=1)
dev.off( )
...
gg.b <- do_line_plot(df,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)

varY = "Nnodeaths"
ylabel = "Samples w/o deaths"

gg.c <- do_line_plot(df,varY,varX,xlabel,ylabel,"mean",scale_x_labels,scale_fill_labels,group_name,nolegend=FALSE)
...
pdf(file=paste(outFile,"_outbreak.pdf",sep=""),width=30,height = 10,title=outFile)
grid.arrange(gg.a,gg.b,gg.c,ncol=3,nrow=1)
dev.off( )
...
xlabel = "Evacuation"
ylabel = "Fraction of population recovered"
scale_x_labels <- c("NO","YES", "safety 2 / NO", "safety 2 / YES") 
